...
export default function MapStats({ jobs, activeCity }) {
  return (
    <div className="fixed top-6 left-6 z-[1000] flex flex-col gap-2 md:flex-row md:items-center">
       <div className="stat-pill glass !bg-white/10 shadow-2xl font-bold flex items-center gap-2">
       ...
       <div className="stat-pill glass transition-all">Monthly: <span className="text-white font-bold ml-1">200</span></div>
    </div>
  );
}
